...
public class Conexion {
	...
	//Atributos
		...
		public void abrirConexion() throws SQLException, ClassNotFoundException {
		     ...
		     miConexion = DriverManager.getConnection("jdbc:mysql://localhost:3306/agenda?useUnicode=true&useJDBCCompliantTimezoneShift=true&useLegacyDatetimeCode=false&serverTimezone=UTC&autoReconnect=true&useSSL=false",
		              "root", "Curso2019$");
